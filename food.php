         ...
         <div class="collapse navbar-collapse mynav" id="toggleMobileMenu">
             <ul class="navbar-nav ms-auto text-center">
                 <li class="nav-item active">
                     <a class="nav-link" href="#" style="margin-right: 20px;">OUR HOTELS</a>
                 </li>
                 <li class="nav-item active">
                     <a class="nav-link" href="#" style="margin-right: 20px;">PROMOTIONS</a>
                 </li>
                 <li class="nav-item active">
                     <a class="nav-link" href="food.php" style="margin-right: 20px;font-weight: bold; color:  #B897F3 !important;">SERVICES</a>
                 </li>
                 <li class="nav-item active dropdown">
                     ...
                     aria-labelledby="navbarDropdown">
                         <li><a href="#" class="dropdown-item">BANGKOK</a></li>
                         <li><a href="#" class="dropdown-item">CHIANG-MAI</a></li>
                         <li><a href="#" class="dropdown-item">PATTAYA</a></li>
                         <li><a href="#" class="dropdown-item">PHUKET</a></li>
                     </ul>
                 </li>
                 <li class="nav-item active dropdown">
                    <a class="nav-link dropdown-toggle" 
    ...
    <div class="food-menu-card" >
        <div>
            ...
            <ul class="nav  tabs-menu-nav justify-content-center mb30" role="tablist">
                <li class="nav-item" role="presentation"><h1>SET MENU</h1></li>
             </ul>
                            ...
                            <article class="media">
                                ...
                                <div class="media-body align-self-center g-pl-10" >
                                    <div class="d-flex justify-content-between mb10" >
                                        <h3 class="align-self-center text-capitalize mb0 h6 text-white font400">SET A</h3>
                               ...
                               <article class="media">
                                ...
                                <div class="media-body align-self-center g-pl-10">
                                    <div class="d-flex justify-content-between mb10">
                                        <h3 class="align-self-center text-capitalize mb0 h6 text-white font400">SET B</h3>
                               ...
                               <article class="media">
                                ...
                                <div class="media-body align-self-center g-pl-10">
                                    <div class="d-flex justify-content-between mb10">
                                        <h3 class="align-self-center text-capitalize mb0 h6 text-white font400">SET C</h3>
                                        <div class="align-self-center">
                                            <strong class="text-white font700">499 Bath</strong>
                                        </div>
                                    </div>
                               ...
                               <article class="media">
                                ...
                                <div class="media-body align-self-center g-pl-10">
                                    <div class="d-flex justify-content-between mb10">
                                        <h3 class="align-self-center text-capitalize mb0 h6 text-white font400">SET D</h3>
                               ...
                               <article class="media">
                                ...
                                <div class="media-body align-self-center g-pl-10">
                                    <div class="d-flex justify-content-between mb10">
                                        <h3 class="align-self-center text-capitalize mb0 h6 text-white font400">SET E</h3>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
              ...
              <div class="advisor_thumb"><img src="ld11.jpg" width="400" alt="">
                <!-- Social Info-->
                <div class="social-info"><h5>50 ฿</h5></div>
                 </div>
              <!-- Team Details-->
          ...
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeInUp;">
             ...
             --> 
             <div class="social-info"><h5>100 ฿</h5></div>
             </div>
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>DRYING</h6>
          ...
          <div class="col-12 col-sm-6 col-lg-4">
            <div class="single_advisor_profile wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
              ...
              <div class="advisor_thumb"><img src="ldd22.jpg" width="400" alt="">
                <!-- Social Info-->
                <div class="social-info"><h5>150 ฿</h5></div>
                 </div>
              <!-- Team Details-->
              <div class="single_advisor_details_info">
                <h6>IRONING</h6>
