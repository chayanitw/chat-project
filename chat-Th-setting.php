    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a  data-toggle="modal" data-target="#edit">แก้ไขโปรไฟล์</a></li>
          <li><a  data-toggle="modal" data-target="#language">ภาษา</a></li>
          <li><a  data-toggle="modal" data-target="#block">การบล็อค</a></li>
          <li><a  data-toggle="modal" data-target="#delete">ลบบัญชี</a></li>
          <li><a  data-toggle="modal" data-target="#log out">ออกจากระบบ</a></li>
        </ul>
      </li>
</div>
  <script>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h1 class="modal-title">ภาษา</h1>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body language -->
      <div class="modal-body">
        <a class="dropdown-item" href="Th_setting.php">ไทย</a>
        <a class="dropdown-item" href="chat-Eng-setting.php">อังกฤษ</a>
      </div>
