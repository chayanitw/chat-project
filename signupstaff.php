...
<!--Modal-->
	<div class="modal-dialog modal-login shadow-lg">
		<div class="modal-content">
            ...
            <form action="confirm_staff.php" method="post">
					<form class="needs-validation" novalidate="">
                        <div class="row">
                        <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="reg-fn">StaffID</label>
                                    <input class="form-control" type="text" required="required" id="reg-fn" placeholder="StaffID" name="StaffID">
                                    <div class="invalid-feedback">Please enter StaffID!</div>  
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
