	...
	<div class="modal-dialog modal-login shadow-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="checkstaff.php" method="post">
					<div class="form-group">
						<label for="login-id">StaffID</label>
						<input type="text" class="form-control" name="staffid" placeholder="StaffID" required="required">		
					</div>
					<div class="form-group">
